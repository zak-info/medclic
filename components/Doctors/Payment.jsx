    ...
    return (
        <>
            ...
            <div className='w-full px-4 flex items-center mt-4'>
                <button className='w-8 h-8 rounded-full bg-secondry-1 flex justify-center items-center'><svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.57721 7.83688H16.4305" stroke="#329cde" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M12.7017 11.0915H12.7094" stroke="#329cde" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M9.00384 11.0915H9.01156" stroke="#329cde" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M5.29825 11.0915H5.30597" stroke="#329cde" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M12.7017 14.3303H12.7094" stroke="#329cde" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M9.00384 14.3303H9.01156" stroke="#329cde" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M5.29825 14.3303H5.30597" stroke="#329cde" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M12.3698 1.66675V4.40906" stroke="#329cde" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M5.63792 1.66675V4.40906" stroke="#329cde" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path fill-rule="evenodd" clip-rule="evenodd" d="M12.5319 2.98267H5.4758C3.02856 2.98267 1.5 4.34594 1.5 6.85185V14.3932C1.5 16.9385 3.02856 18.3333 5.4758 18.3333H12.5242C14.9791 18.3333 16.5 16.9622 16.5 14.4563V6.85185C16.5077 4.34594 14.9868 2.98267 12.5319 2.98267Z" stroke="#329cde" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg></button>
            ...
            <div className='w-full px-4 flex items-center mt-4'>
                <button className='w-8 h-8 rounded-full bg-secondry-1 flex justify-center items-center'><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.57693 1.32422H5.4611C2.8986 1.32422 1.29193 3.13839 1.29193 5.70672V12.6351C1.29193 15.2034 2.8911 17.0176 5.4611 17.0176H12.8144C15.3853 17.0176 16.9844 15.2034 16.9844 12.6351V9.27838" stroke="#329cde" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path fill-rule="evenodd" clip-rule="evenodd" d="M6.35652 8.10074L12.584 1.87324C13.3599 1.09824 14.6174 1.09824 15.3932 1.87324L16.4074 2.88741C17.1832 3.66324 17.1832 4.92158 16.4074 5.69658L10.1499 11.9541C9.81069 12.2932 9.35069 12.4841 8.87069 12.4841H5.74902L5.82736 9.33408C5.83902 8.87074 6.02819 8.42908 6.35652 8.10074Z" stroke="#329cde" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M11.6377 2.83545L15.4427 6.64045" stroke="#329cde" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg></button>
            ...
            <div className='w-full flex justify-center mt-4'>
                <button onClick={(e)=>{setPopUp(true)}} type='submit' className='w-3/5 bg-primary-1 py-2  flex justify-center rounded-full font-semibold text-white' >Make Payment</button>
            </div>
            {
                popUp ?
                    <Popup closePopup={(e)=>{setPopUp(false)}}>
                    ...
                    <p className='text-sm mt-4 text-center'>Your payment has been successful, you can have a consultation session with your trusted Admin</p>
                    <Link href='/doctors/werq/chat' className='w-4/5 mt-12 bg-primary-1 py-2  flex justify-center rounded-full font-semibold text-white' >Chat Admin</Link>
