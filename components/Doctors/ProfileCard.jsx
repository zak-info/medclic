...
const ProfileCard = ({ user }) => {
    return (
        <div className='w-11/12 h-32 bg-white  rounded-2xl flex items-center '>
            ...
            <div class="w-24 h-24 bg-[#329cde]  border border-white rounded-full flex justify-center items-center text-5xl font-bold text-white" alt="">{getFirstLetters(user?.fullname)}</div>

            <div className='h-5/6 pt-3 ms-4'>
                <h1 className='font-bold text-sm'>Ph. {user?.fullname}</h1>
