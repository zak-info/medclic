...
const ExchangeCom = ({ exchanges }) => {
    console.log("exchanges : exchanges ",exchanges);
    return (
        <div className='w-screen h-screen pt-8 flex flex-col items-center'>
            <div className='w-full flex justify-between px-8'>
                <h1 className='text-xl font-bold w-2/3'>Exchange</h1>
            ...
            </div>
            {
                exchanges?.map((ph, index) => (
                    <Card key={index} data={{...ph?._doc,imageUrl:'/images/dwa.svg'}} />
                ))
            }
