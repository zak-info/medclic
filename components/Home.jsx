                    ...
                    <>
                        <div className='w-full flex gap-4 justify-between'>
                            <div className='w-3/5 h-52 bg-cover flex flex-col gap-4 justify-center items-center pb-4 rounded-lg bg-blue-400'>
                                ...
                                <Link href='/dashboard/home' className='w-4/5  text-sm  text-center  bg-white py-2  flex justify-center rounded-full  font-semibold text-blue-400' >Parcourir les stocks à échanger</Link>
                            </div>
                            <div className='w-3/5 h-52 bg-cover flex flex-col gap-4 justify-center items-center pb-4 rounded-lg bg-blue-400'>
                                <div className='p-1 rounded-full bg-white'>
                        ...
                        <div className='w-full flex gap-4 justify-between mt-4'>
                            <div className='w-3/5 h-52 bg-cover flex flex-col gap-4 justify-center items-center pb-4 rounded-lg bg-blue-400'>
                                ...
                                <Link href='/dashboard/exchange' className='w-4/5  text-sm  text-center  bg-white py-2  flex justify-center rounded-full  font-semibold text-blue-400' >Page de publication</Link>
                            </div>
                            <div className='w-3/5 h-52 bg-cover flex flex-col gap-4 justify-center items-center pb-4 rounded-lg bg-blue-400'>
                                <div className='p-1 rounded-full bg-white'>
                                    <img src="/images/icon4.png" className="w-12 h-12" />
                                </div>
                                <Link href='/dashboard/exchange' className='w-4/5  text-sm  text-center  bg-white py-2  flex justify-center rounded-full  font-semibold text-blue-400' >Publier un stock à échanger</Link>
                            </div>
                        </div>
                    </>
                }
