                    ...
                    <>
                        ...
                        <div className='w-full mt-6 px-4'>
                            <Chip color={user?.data?.delivary == "true" ? "success" : "danger"} className='text-white'  >
                                {user?.data?.delivary == "true" ? "livraison disponible" : "livraison indosponible"}
                            </Chip>
                        </div>
                        ...
                        <div className='w-4/5 h-12 mt-6 border rounded-full border-primary-1-hover flex items-center '>
                            ...
                            <input type="text" className='ms-2 border-none w-2/3 outline-none bg-none text-sm' placeholder='Écrire pour  recherche' />
                        </div>
                        ...
                        <div className='w-4/5 flex justify-between p-4 rounded-xl mt-4 bg-secondry-1 '>
                            ...
                            {/* blurDataURL={products[0]?.base64Placeholder} */}
                        </div>

                        <div className='w-full flex justify-end mt-4 px-10'>
                            {
                                currentUser?.type == "user" ?
                                    <CreateCommand pharmacy={user} idPharmacy={user?._id} user={currentUser} />
                                    :
                                    null
                            }
                            {
