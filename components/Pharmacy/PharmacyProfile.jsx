...
const PharmacyProfile = ({ user,currentUser, products,myProducts }) => {
                ...
                section == "ph" ?
                    <>
                        ...
                        <div className='w-4/5 h-12 mt-6 border rounded-full border-primary-1-hover flex items-center '>
                            ...
                            <input type="text" className='ms-2 border-none w-2/3 outline-none bg-none text-sm' placeholder='enter your desire search' />
                        </div>
                        ...
                        <div className='w-4/5 flex justify-between p-4 rounded-xl mt-4 bg-secondry-1 '>
                            ...
                            <Image src={products[0]?.imageUrl} placeholder="blur" blurDataURL={products[0]?.base64Placeholder} width={1000} height={1000} className='w-24 h-16 ' />
                        </div>

                        <div className='w-full flex justify-end mt-4 px-10'>
                            {
                                currentUser?.type == "user" ?
                                    <CreateCommand idPharmacy={user?._id} user={currentUser} />
                                    :
                                    null
                            }
                            {
