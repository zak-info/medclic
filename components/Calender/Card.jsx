    ...
    return (
        <div className='w-5/6 border rounded-lg px-4 mt-6 py-3'>
            ...
            <div className='w-full flex items-center mt-6'>
                ...
                <span className='text-xs ms-1'>{data?.address}</span>
                ...
                <a href={"tel:"+data?.phone}><i class="ri-phone-line ms-4 text-primary-1"></i></a>
                <span className='text-xs ms-1'>{data?.phone}</span>
                <span className='w-1 h-1 bg-primary-1 rounded-full ms-4'></span>
                <span className='text-xs ms-1'>Confirmed</span>
            </div>
            <div className='w-full flex justify-evenly mt-4'>
                <a href={"/dashboard/pharmacy/"+data?._id} className='w-2/5 text-center py-2 bg-secondry-1 rounded-lg'>Order</a>
                <a href={"/dashboard/pharmacy/"+data?._id} className='w-2/5 text-center py-2 bg-primary-1 text-white rounded-lg'>Visit</a>
