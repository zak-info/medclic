                ...
                <Dropdown >
                    <DropdownTrigger>
                        <div className="flex m-4 md:me-8 hover:cursor-pointer">
                            <div class="relative ">
                                <div class="w-10 h-10 bg-[#329cde]  border border-white rounded-full flex justify-center items-center text-white" alt="">{getFirstLetters(user?.fullname)}</div>
                    ...
                    <DropdownMenu aria-label="Static Actions" className="bg-white rounded-lg py-4 px-2">
                        ...
                        <DropdownItem key="new">
                            <div className="flex items-center   p-2 rounded-xl" dir="ltr" onClick={logout}>
